    ...
    <div>
      ...
      <form className='form-control' onSubmit={handleSubmit}>
        <div className='form-floating'>
          <input id="attribute" name='Attribute' maxLength={LongMax}   placeholder='' minLength={LongMin} className="form-control" type="number" value={attribute} required onChange={(e) => setAttribute(e.target.value)} />
        ...
        <div className='row justify-content-around align-items-center mb-2 mt-3'>
          ...
          <Link id="volver" className=" col-3 btn btn-warning " to={`/cita/${id}`} >Volver </Link>
        </div>
